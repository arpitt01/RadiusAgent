    ...
    if request.method == "POST":
        ...
        if lo_url['ev_errorNumber'] != 0:
            ...
            if lo_issues_data.status_code == 403:
                ...
                lv_last_24hrs_issues = \
                requests.get(lv_api_main + lv_api_created_tag + Data.getOldTimeStamp(1) + lv_api_pagination).json()[
                    "total_count"]
                # subtracting number of issues occured in last 24 hours from no. of issues in last 7 days
                lv_last_24hrs_to_7days_issues = \
                requests.get(lv_api_main + lv_api_created_tag + Data.getOldTimeStamp(7) + lv_api_pagination).json()[
                    "total_count"] - lv_last_24hrs_issues
